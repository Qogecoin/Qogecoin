...
#ifndef QOGECOIN_KERNEL_CONTEXT_H
#define QOGECOIN_KERNEL_CONTEXT_H
...
//! passed to external libqogecoin_kernel functions which need access to this
...
#endif // QOGECOIN_KERNEL_CONTEXT_H
